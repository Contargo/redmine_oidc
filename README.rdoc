...
{SWD}[https://github.com/nov/swd] is a client library which is used by the
{OpendIDConnect}[https://github.com/nov/openid_connect] library to process web
discovery. By default it accesses resources via +URI::HTTPS+, i.e. secure
connections, which makes perfect sense in production context. In a local
development environment we do not have or want to use secure communication. To
achieve this set
  SWD.url_builder = URI::HTTP

in a respective environment configuration,
